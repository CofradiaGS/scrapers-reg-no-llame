...
En el código fuente, la configuración se asocia al enum de dominio [`Prioridad`](file:///c:/Users/Usuario/Documents/GitHub/scraper%20iris%20reg%20no%20llame/core/domain/enums.py#L8-L17) mediante el diccionario [`PRIORIDADES_CONFIG`](file:///c:/Users/Usuario/Documents/GitHub/scraper%20iris%20reg%20no%20llame/adapters/queue/mysql_vps_adapter.py#L30-L34):
...
Para mitigar el costo de búsquedas en colas vacías, [`MySQLQueueAdapter`](file:///c:/Users/Usuario/Documents/GitHub/scraper%20iris%20reg%20no%20llame/adapters/queue/mysql_vps_adapter.py#L42) implementa un registro interno de agotamiento temporal:
