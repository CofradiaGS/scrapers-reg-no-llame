...
* **Escalabilidad Horizontal Lineal**: Es posible elevar la cantidad de workers concurrentes (ej. 9 workers en [`SupervisorIndustrial`](file:///c:/Users/Usuario/Documents/GitHub/scrapers-reg-no-llame/runtime/supervisor.py#L37)) sin que se degraden los tiempos de respuesta de la base de datos.
...
En [`MySQLQueueAdapter.reservar_lote`](file:///c:/Users/Usuario/Documents/GitHub/scrapers-reg-no-llame/adapters/queue/mysql_vps_adapter.py#L102-L141), la reserva se realiza en dos fases atómicas bajo la misma conexión con `autocommit=False`:
