...
El puerto secundario o conducido (*Driven Port*) [`IScraperEnginePort`](file:///c:/Users/Usuario/Documents/GitHub/scrapers-reg-no-llame/core/ports/scraper_port.py) define el contrato abstracto que cualquier motor de extracción externa debe implementar para operar dentro del ecosistema hexagonal del proyecto.
...
- **Semántica**: Es la clave bajo la cual se reclama el lote en la base de datos (`scraper_actual = 'claro'`), la clave del namespace en el JSON enriquecido (`datos_json = {"claro": {...}}`), y el nombre de referencia en [`ReglaPipeline`](file:///c:/Users/Usuario/Documents/GitHub/scrapers-reg-no-llame/core/domain/entities.py#L126-L172).
...
- **Parámetro**: [`Linea`](file:///c:/Users/Usuario/Documents/GitHub/scrapers-reg-no-llame/core/domain/entities.py#L12-L38) (*Value Object* inmutable que garantiza un ANI numérico de 10 dígitos).
- **Retorno**: [`ScrapeResult`](file:///c:/Users/Usuario/Documents/GitHub/scrapers-reg-no-llame/core/domain/entities.py#L97-L131) tipado con enum `StatusScraping`.
...
Para evitar duplicación de código en la gestión de pausas aleatorias que protegen la tasa de peticiones del portal remoto, el framework provee [`BaseScraperAdapter`](file:///c:/Users/Usuario/Documents/GitHub/scrapers-reg-no-llame/adapters/scrapers/base_scraper.py):
