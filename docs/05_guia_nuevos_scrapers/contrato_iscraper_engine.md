...
- **Parámetro**: [`Linea`](file:///c:/Users/automatizacion.crm/Documents/GitHub/scrapers-reg-no-llame/core/domain/entities.py#L12-L38) (*Value Object* inmutable que garantiza un ANI numérico de 10 dígitos).
- **Retorno**: [`ScrapeResult`](file:///c:/Users/automatizacion.crm/Documents/GitHub/scrapers-reg-no-llame/core/domain/entities.py#L97-L131) tipado con enum `StatusScraping`.
...
Para evitar duplicación de código en la gestión de pausas aleatorias que protegen la tasa de peticiones del portal remoto, el framework provee [`BaseScraperAdapter`](file:///c:/Users/automatizacion.crm/Documents/GitHub/scrapers-reg-no-llame/adapters/scrapers/base_scraper.py):
