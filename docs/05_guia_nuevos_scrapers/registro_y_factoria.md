...
El componente [`ScraperRegistry`](file:///c:/Users/Usuario/Documents/GitHub/scraper%20iris%20reg%20no%20llame/adapters/scrapers/registry.py) implementa el patrón **Registry / Service Locator** para la resolución dinámica e instanciación de motores de scraping en tiempo de ejecución.
