...
En el núcleo de la arquitectura ([`core/domain/`](file:///c:/Users/automatizacion.crm/Documents/GitHub/scrapers-reg-no-llame/core/domain)), los modelos representan los conceptos centrales del negocio de telecomunicaciones y procesamiento de colas.
...
La clase [`Titular`](file:///c:/Users/automatizacion.crm/Documents/GitHub/scrapers-reg-no-llame/core/domain/entities.py#L39-L62) encapsula la información de titularidad registral y comercial de la línea obtenida de cualquier motor de extracción:
...
La clase [`Servicio`](file:///c:/Users/automatizacion.crm/Documents/GitHub/scrapers-reg-no-llame/core/domain/entities.py#L64-L77) encapsula las características técnicas y comerciales del plan telefónico:
...
La clase [`RegistroCola`](file:///c:/Users/automatizacion.crm/Documents/GitHub/scrapers-reg-no-llame/core/domain/entities.py#L114-L124) representa un registro individual extraído y reservado de la cola de base de datos para su procesamiento:
...
| `ani` | `BIGINT` | `linea` | [`Linea`](file:///c:/Users/automatizacion.crm/Documents/GitHub/scrapers-reg-no-llame/core/domain/entities.py#L10) |
| (Calculado por B-Tree) | N/A | `prioridad` | [`Prioridad`](file:///c:/Users/automatizacion.crm/Documents/GitHub/scrapers-reg-no-llame/core/domain/enums.py#L8) |
| (Calculado por B-Tree) | N/A | `prioridad_nombre` | `str` |
| `estado` | `ENUM(...)` | `estado` | [`EstadoRegistro`](file:///c:/Users/automatizacion.crm/Documents/GitHub/scrapers-reg-no-llame/core/domain/enums.py#L36) |
...
El archivo [`core/domain/enums.py`](file:///c:/Users/automatizacion.crm/Documents/GitHub/scrapers-reg-no-llame/core/domain/enums.py) provee las definiciones constantes que garantizan tipado fuerte en todo el sistema:
...
- [Arquitectura Hexagonal](file:///c:/Users/automatizacion.crm/Documents/GitHub/scrapers-reg-no-llame/docs/01_arquitectura/arquitectura_hexagonal.md)
