...
* **Firma / Implementación:** `cmd_stats(args)` en [main.py](file:///c:/Users/Usuario/Documents/GitHub/scrapers-reg-no-llame/main.py#L40-L63).
* **Adaptador utilizado:** Instancia de [`MySQLQueueAdapter`](file:///c:/Users/Usuario/Documents/GitHub/scrapers-reg-no-llame/adapters/queue/mysql_vps_adapter.py#L36) con pool dedicado (`cli_stats_pool`, `pool_size=2`).
...
### 2.2. `list-scrapers`
Lista todos los adaptadores de scraping registrados dinámicamente en el [`ScraperRegistry`](file:///c:/Users/Usuario/Documents/GitHub/scrapers-reg-no-llame/adapters/scrapers/registry.py).

* **Firma / Implementación:** `cmd_list_scrapers(args)` en [main.py](file:///c:/Users/Usuario/Documents/GitHub/scrapers-reg-no-llame/main.py#L65-L74).
* **Sintaxis PowerShell / CMD:**
  ```powershell
...
* **Firma / Implementación:** `cmd_test_line(args)` en [main.py](file:///c:/Users/Usuario/Documents/GitHub/scrapers-reg-no-llame/main.py#L76-L108).
* **Parámetros y Flags:**
...
### 2.4. `test-batch`
Prueba el ciclo transaccional completo del caso de uso [`ProcesarLoteUseCase`](file:///c:/Users/Usuario/Documents/GitHub/scrapers-reg-no-llame/core/use_cases/process_batch_use_case.py). Permite probar con la base de datos real del VPS o en modo aislado en memoria (`--dry-run`).

* **Firma / Implementación:** `cmd_test_batch(args)` en [main.py](file:///c:/Users/Usuario/Documents/GitHub/scrapers-reg-no-llame/main.py#L110-L148).
* **Parámetros y Flags:**
  | Argumento / Flag | Tipo | Default | Descripción |
  | :--- | :---: | :---: | :--- |
  ...
  | `--dry-run` | Flag booleano | `False` | Utiliza [`MemoryQueueAdapter`](file:///c:/Users/Usuario/Documents/GitHub/scrapers-reg-no-llame/adapters/queue/memory_adapter.py) con ANIs simulados sin tocar la BD VPS |
...
* **Firma / Implementación:** `cmd_sweep_orphans(args)` en [main.py](file:///c:/Users/Usuario/Documents/GitHub/scrapers-reg-no-llame/main.py#L150-L156).
* **Parámetros y Flags:**
  | Argumento / Flag | Tipo | Default | Descripción |
  | :--- | :---: | :---: | :--- |
...
### 2.6. `supervise`
Inicia el orquestador industrial [`SupervisorIndustrial`](file:///c:/Users/Usuario/Documents/GitHub/scrapers-reg-no-llame/runtime/supervisor.py) directamente desde la interfaz de `main.py`.

* **Firma / Implementación:** `cmd_supervise(args)` en [main.py](file:///c:/Users/Usuario/Documents/GitHub/scrapers-reg-no-llame/main.py#L158-L176).
* **Parámetros y Flags:**
