...
La función [`parse_iris_detail()`](file:///c:/Users/Usuario/Documents/GitHub/scrapers-reg-no-llame/adapters/scrapers/iris/parser.py#L21-L113) recibe el código HTML completo de la pantalla de *Detalle de Operación* y procesa cinco secciones de datos:
