...
La lógica de control reside en el bucle principal de [`worker_lifecycle_process`](file:///c:/Users/Usuario/Documents/GitHub/scraper%20iris%20reg%20no%20llame/runtime/worker_process.py#L118-L161).
...
Para evitar esto, en la línea 136 de [`runtime/worker_process.py`](file:///c:/Users/Usuario/Documents/GitHub/scraper%20iris%20reg%20no%20llame/runtime/worker_process.py#L136):
```python
...
Cuando el bucle `while` rompe, la ejecución entra indefectiblemente en el bloque `finally` de [`runtime/worker_process.py`](file:///c:/Users/Usuario/Documents/GitHub/scraper%20iris%20reg%20no%20llame/runtime/worker_process.py#L164-L181):
...
En [`supervisor_vps.py`](file:///c:/Users/Usuario/Documents/GitHub/scraper%20iris%20reg%20no%20llame/supervisor_vps.py#L68), el operador puede parametrizar la cadencia de rotación según la memoria RAM disponible en el nodo de cómputo:
