...
El Circuit Breaker se orquesta en el método [`_circuit_breaker_loop`](file:///c:/Users/Usuario/Documents/GitHub/scraper%20iris%20reg%20no%20llame/runtime/supervisor.py#L63-L96) de [`SupervisorIndustrial`](file:///c:/Users/Usuario/Documents/GitHub/scraper%20iris%20reg%20no%20llame/runtime/supervisor.py#L31), ejecutándose como un hilo de soporte en segundo plano (`CircuitBreakerThread`).
...
En [`runtime/worker_process.py`](file:///c:/Users/Usuario/Documents/GitHub/scraper%20iris%20reg%20no%20llame/runtime/worker_process.py#L126-L133), antes de intentar reclamar cualquier nuevo lote a la base de datos MySQL, cada worker evalúa la condición del Circuit Breaker:
